...
| 功能模块               | 截图预览                                                                         |
| :----------------- | :--------------------------------------------------------------------------- |
| 落地页(Landing)      | ![Landing Page](public/images/screenshots/screenshot-landing.png)            |
| 产品上传页(Upload)     | ![Upload](public/images/screenshots/screenshot-upload.png)                   |
| AI策划页(Blueprint) | ![Planning](public/images/screenshots/screenshot-planning.png)               |
| 策划详情页(Detail)     | ![Planning Detail](public/images/screenshots/screenshot-planning-detail.png) |

### 策划列表与详情

| 功能模块               | 截图预览                                                                            |
| :----------------- | :------------------------------------------------------------------------------ |
| 策划列表页(Shot List)  | ![Planning List](public/images/screenshots/screenshot-planning-list.png)        |
| 策划详情页2(Detail 2) | ![Planning Detail 2](public/images/screenshots/screenshot-planning-detail2.png) |

### 支付与定价

| 功能模块           | 截图预览                                                     |
| :------------- | :------------------------------------------------------- |
| 定价页(Pricing)     | ![Pricing](public/images/screenshots/screenshot-pricing.png) |

### 主题对比(Dark & Light)

| 主题                 | 截图预览                                                             |
| :----------------- | :--------------------------------------------------------------- |
| 深色主题登录页(Dark Theme)  | ![Login Dark](public/images/screenshots/screenshot-login-dark.png)   |
| 浅色主题登录页(Light Theme) | ![Login Light](public/images/screenshots/screenshot-login-light.png) |

### 画廊与编辑功能

| 功能模块                | 截图预览                                                            |
| :------------------ | :-------------------------------------------------------------- |
| 历史图库(Creative Gallery) | ![Gallery](public/images/screenshots/screenshot-gallery.png)      |
| 结果详情页(Result Detail) | ![Result Detail](public/images/screenshots/screenshot-result-detail.png) |
| 编辑优化+版本管理(Refine & Version) | ![Refine](public/images/screenshots/screenshot-refine.png) |
